...
namespace MediaManager.Demo
{
    public partial class HomePage : ContentPage
    {
        ...
        private void CurrentOnStatusChanged(object sender, Plugin.MediaManager.Abstractions.EventArguments.StatusChangedEventArgs e)
        {
            System.Diagnostics.Debug.WriteLine($"MediaManager Status: {e.Status}");
        }
